...
const documentFiles: DataFile[] = [
  {
    id: "doc-1",
    name: "Katalog_Kue_Lebaran_2026.pdf",
    type: "pdf",
    size: "2.4 MB",
    uploadedAt: "25 Feb 2026",
    usedBy: "Asisten Toko Kue",
    usedByVariant: "bot",
    status: "active",
  },
  {
    id: "doc-2",
    name: "Menu_Kopi_Premium.pdf",
    type: "pdf",
    size: "1.8 MB",
    uploadedAt: "20 Feb 2026",
    usedBy: "Asisten Toko Kopi",
    usedByVariant: "bot",
    status: "active",
  },
  {
    id: "doc-3",
    name: "FAQ_Layanan_Klinik.txt",
    type: "txt",
    size: "340 KB",
    uploadedAt: "18 Feb 2026",
    usedBy: "CS Klinik Sehat",
    usedByVariant: "bot",
    status: "syncing",
  },
  {
    id: "doc-4",
    name: "Panduan_Pemesanan_Online.pdf",
    type: "pdf",
    size: "3.1 MB",
...
const transactionFiles: DataFile[] = [
  {
    id: "trx-1",
    name: "Penjualan_Februari_2026.csv",
    type: "csv",
    size: "856 KB",
