...
const mockBots: ChatbotItem[] = [
  {
    id: "bot-1",
    name: "Asisten Toko Kopi",
    status: "active",
    knowledgeFile: "menu_kopi.pdf",
    channels: [
    ...
    totalChats: 1_247,
    shareUrl: "https://intara.id/chat/toko-kopi",
    createdAt: "12 Jan 2026",
    lastActive: "2 jam lalu",
  },
  {
    id: "bot-2",
    name: "CS Klinik Sehat",
    status: "active",
    knowledgeFile: "layanan_klinik.pdf",
    channels: [
      { name: "Web", icon: <Globe className="h-3.5 w-3.5" /> },
      { name: "WhatsApp", icon: <MessageCircle className="h-3.5 w-3.5" /> },
    ],
    totalChats: 583,
    shareUrl: "https://intara.id/chat/klinik-sehat",
